		...
		return {
			...
			_initMenuItems() {
				...
				this.menuItems = Array.from(
					this.menuElement.querySelectorAll(focusableElements),
				);
			...
			connected() {
				...
				if (this.openOnHover) this._addOpenOnHoverEventHandlers();
			},
			...
			disconnected() {
				...
				if (this.openOnHover) this._removeOpenOnHoverEventHandlers();
			},
