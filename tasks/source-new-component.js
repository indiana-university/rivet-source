...
console.log(
	`Wrote file for new component "${componentName}" to src/sass/${componentSlug}/_index.scss.`,
);

jetpack.write(componentSassBasePath, componentSassStarterCode);
console.log(
	`Wrote file for new component "${componentName}" to src/sass/${componentSlug}/_base.scss.`,
);
...
if (!sassOnly) {
	...
	console.log(
		`Wrote file for new component "${componentName}" to src/js/components/${componentSlug}.js.`,
	);
}
...
if (!sassOnly) exec(`code -r ${componentJsPath}`);
